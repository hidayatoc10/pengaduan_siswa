...
<form action="" method="POST">
    <div class="form-row p-3">
        <div class="form-group">
            ...
            <p class="text-sm"><span style="color: red;">*</span>Harap catat kode ini untuk melakukan pengecekan sendiri
                melalui kolom pencarian.</p>
            <div>
                <div class="form-group">
                    ...
                    <div>
                        <div class="form-group">
                            <label for="jabatan">Kelas Pelapor</label>
                            <input type="text" name="jabatan" id="jabatan" class="form-control" required>
                            <div>
                                <div class="form-group">
                                    <label for="dept">NISN</label>
                                            ...
                                            <div>
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="ket" id="ket" class="form-control"
                                                        required></textarea>
                                                    <div>
                                                        <button class="btn btn-outline-success mt-3 mr-3" type="submit"
                                                            name="submit" style="width: 100px;"><span
                                                                class="fas fa-paper-plane mr-2"></span>Kirim</button>
                                                        <button class="btn btn-outline-danger mt-3" type="reset"
                                                            name="reset" style="width: 130px;"><span
