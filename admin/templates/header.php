...
<head>
  ...
  <title>SMKN 17 JAKARTA</title>
  <link rel="icon" href="../assets/dist/img/logoSMK.png">
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index.php" class="brand-link">
        <img src="../assets/dist/img/logoSMK.png" alt="SI-PEKERBA"
          class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light" style="font-size: 19px;">Pengaduan</span>
      </a>
